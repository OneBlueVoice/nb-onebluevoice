...
(function ( $, window, document, undefined ) {
  ...
  Plugin.prototype = {
            ...
            if (ytid) {
              ...
              if (self.options.addThumbs) {
                ...
                if(self.options.thumbSize == 'small') {
                  thumbUrl = self._protocol + 'img.youtube.com/vi/' + ytid + '/hqdefault.jpg';
                }
                else {
                  thumbUrl = self._protocol + 'img.youtube.com/vi/' + ytid + '/hqdefault.jpg';
                }
      ...
      getNewEmbedCode: function(options, id) {
        ...
        html += ' src="' + this._protocol + 'www.youtube.com/embed/' + id + '?wmode=opaque&autoplay=' + options.autoPlay + '" frameborder="0"';
